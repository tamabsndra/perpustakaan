        ...
        <header class="absolute inset-x-0 top-0 z-50">
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div class="flex lg:flex-1">
                    @auth
                    <label class="text-sm font-semibold leading-6 text-gray-900">Welcome, {{ Auth::user()->nama }}! ✨</label>
                    @endauth
                </div>
                ...
                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    ...
                    <form action="{{route('logout')}}" method="post">
                        @csrf
                        <button hidden id="logout" type="submit">Log out</button>
                        <label for="logout" class="text-sm font-semibold cursor-pointer leading-6 text-gray-900">Log out</label>
                    </form>
                    @endauth
                </div>
            </nav>

    ...
    <div class="px-4 mt-20 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-4xl font-semibold leading-6 text-gray-900">Book Borrow History</h1>
                <p class="mt-2 text-sm text-gray-700">A list of all the books that you returned.</p>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $item->tgl_kembali }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>

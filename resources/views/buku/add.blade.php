<button data-modal-target="add-book" data-modal-toggle="add-book"
...
<!-- Main modal -->
<div id="add-book" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form action="{{route('buku.store')}}" method="post" class="p-4 md:p-5">
                @csrf

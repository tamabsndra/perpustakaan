<button data-modal-target="add-member" data-modal-toggle="add-member"
...
<!-- Main modal -->
<div id="add-member" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form action="{{route('member.store')}}" method="post" class="p-4 md:p-5">
                @csrf
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        <label for="tgl_lahir"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Day Of Birth</label>
